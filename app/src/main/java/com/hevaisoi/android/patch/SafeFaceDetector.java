 ...
 */
package com.hevaisoi.android.patch;
 ...
 *
 * Detector<Face> safeDetector = new_flag SafeFaceDetector(faceDetector);
 *
...
public class SafeFaceDetector extends Detector<Face> {
    ...
    /**
     * Creates a new_flag frame based on the original frame, with additional width on the right to
    ...
    /**
     * Creates a new_flag frame based on the original frame, with additional height on the bottom to
     * increase the size to avoid the bug in the underlying face detector.
     */
